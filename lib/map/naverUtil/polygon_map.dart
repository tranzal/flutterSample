...
class _PolygonMapState extends State<PolygonMap>
  ...
  void initState() {
    ...
    _polygon.add(PolygonOverlay(
      'default polygon',
      [
        const LatLng(37.56823358823172, 126.9838688358965),
        const LatLng(37.56507279644869, 126.98367937726825),
        const LatLng(37.56488686334351, 126.97757159196705),
        const LatLng(37.56770441524463, 126.97814898969123),
      ],
      holes: [
        [
          const LatLng(37.56701846799908, 126.97985252649414),
          const LatLng(37.567087551633634, 126.9804335687986),
          const LatLng(37.566366008290366, 126.98161502148443),
          const LatLng(37.56585171249225, 126.97966852976435),
        ]
      ],
        ...
        children: <Widget>[
          NaverMap(
            ...
            initialCameraPosition: const CameraPosition(
                target: const LatLng(37.56595018951271, 126.97728338254345)),
          ),
          Align(
    ...
    if (!_isAdding) {
      ...
      if (_markers.length >= 3) {
        _polygon.add(PolygonOverlay(
          ...
          _markers.map((e) => e.position).toList().cast(),
